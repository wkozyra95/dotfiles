...
local function spell_file_rebuild()
    local spell_dir = vim.env.HOME .. "/.dotfiles/configs/nvim/spell"
...
function module.preset(name)
    local common = vim.env.HOME .. "/.dotfiles/configs/nvim/spell/common.utf-8.add"
    local lang = vim.env.HOME .. "/.dotfiles/configs/nvim/spell/" .. name .. ".utf-8.add"
    local natural = vim.env.HOME .. "/.dotfiles/configs/nvim/spell/natural.utf-8.add"
...
function module.strict_preset()
    ...
    vim.opt_local.spellfile = vim.env.HOME .. "/.dotfiles/configs/nvim/spell/natural.utf-8.add"
end
